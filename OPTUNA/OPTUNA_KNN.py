...
def objective(trial):
    params = {
        'kneighborsclassifier__n_neighbors': trial.suggest_int('kneighborsclassifier__n_neighbors', 1, 70),
        'kneighborsclassifier__weights': trial.suggest_categorical('kneighborsclassifier__weights', ['uniform', 'distance']),
        'kneighborsclassifier__p': trial.suggest_int('kneighborsclassifier__p', 1, 2)  
    }
